...
export interface OperationsService { list(): Promise<OperationDocumentDTO[]>; get(id: ID): Promise<OperationDocumentDTO | null>; history(id:ID):Promise<OperationRevisionDTO[]>; create(payload: OperationPayload, actorId: ID, documentAt?:ISODateTime): Promise<OperationDocumentDTO>; update(id:ID,payload:OperationPayload,actorId:ID,documentAt?:ISODateTime):Promise<OperationDocumentDTO>; post(id: ID, actorId: ID): Promise<OperationDocumentDTO>; reverse(id: ID, actorId: ID): Promise<OperationDocumentDTO> }
