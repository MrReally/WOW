...
export function MySettingsPage() {
  ...
  const advancedLabel: Record<Notifications.AdvancedNotificationEvent, string> = {
    ...
    "project.ping.created": "Пинг отправлен (со списком получателей)",
    "project.ping.confirmed": "Подтвердили участие по пингу",
    "project.ping.declined": "Отказались от участия по пингу",
